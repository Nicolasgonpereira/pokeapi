        ...
        <>
            {selectedPokemon ? (
                <Modal
                    open={open}
                    onClose={onClose}>
                    <Box sx={{width:'40%',minHeight:'70%',boxShadow:20, backgroundColor:pokeColors[pokemon.types[0].type.name],top:'15vh',left:'30vw',transform:'translate(30vw,15vh)',borderRadius:'20px',textAlign:'center',outline:'none'}}>
